...
import xidian.sce.wland2d.logger.Log;
import xidian.sce.wland2d.logger.LogFragment;
import xidian.sce.wland2d.logger.LogWrapper;
import xidian.sce.wland2d.logger.MessageOnlyLogFilter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        z = pairing.getZr();
        T(z.newElement(2), z.newElement(4));
    ...
    class SourceWorker extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.d(TAG, String.format("Total time for protocol => %sms", t));
